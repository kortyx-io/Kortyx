...
export function DocsRightRail(props: DocsRightRailProps) {
  ...
  return (
    <aside className="hidden xl:block xl:sticky xl:top-4 xl:h-[calc(100vh-2rem)] xl:overflow-hidden">
      <div className="h-full overflow-y-auto pl-4">
        {description ? (
          <p className="mb-6 text-sm leading-5 text-zinc-600">{description}</p>
        ) : null}
